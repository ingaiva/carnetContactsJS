// Script sans rechargement du tableau avec la gestion des classes
...
function getContactFromJson(jContact){
    ...
    if(elem.cType=="pro"){
        ...
        return new ContactPro(elem.cId, elem.cName, elem.cLastName, elem.cMail, elem.cTel,elem.cActif,elem.cType,ldn);
    }
    else{
        let fb="";
        if ('facebook' in elem ){
        ...
        return new ContactPerso(elem.cId, elem.cName, elem.cLastName, elem.cMail, elem.cTel,elem.cActif,elem.cType,fb);
    }   
}
